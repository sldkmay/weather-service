...
from . import views
from .views import UserFavoriteCityCreateView, UserFavoriteCityUpdateView, CityListView, WeatherDataListView, WeatherDataCreateView, WeatherDataDeleteView, WeatherDataDetailView, WeatherDataSyncAllView, AllWeatherDataListView, MyWeatherDataListView, unfavorite_city, signup
...
urlpatterns = [
    ...
    path("my-cities/<int:pk>/edit-favorite/", UserFavoriteCityUpdateView.as_view(), name="edit_favorite_city"),
    path("my-cities/<int:pk>/unfavorite/", unfavorite_city, name="unfavorite_city"),
